...
//Binderbyte
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://dev.farizdotid.com/api/daerahindonesia/kecamatan?id_kota='.$id_kabupaten,
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
foreach ($kecamatan as $d) { ?>
  <option value="<?php echo $d['nama']; ?>" id_kecamatan="<?php echo $d['id']; ?>"><?php echo $d['nama']; ?></option>
  <?php } ?>